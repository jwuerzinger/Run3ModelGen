...
#SBATCH --array=1-100
#SBATCH -o ./slurm_run/out_%A/out.%a
#SBATCH -e ./slurm_run/err_%A/err.%a
#SBATCH -D ./
#SBATCH --mem=8G
#SBATCH --time=0:10:00
...
srun pixi run genModels.py --config_file $HOME/Run3ModelGen/config_files/MSSM19atQ.yaml --scan_dir $HOME/Run3ModelGen/runs/slurm_run/$SLURM_ARRAY_JOB_ID$SLURM_ARRAY_TASK_ID --custom_model True 
